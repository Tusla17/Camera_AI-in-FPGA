...
using hls::sim::Byte;
extern "C" void mini_top(Byte<4>*, volatile void *);
extern "C" void apatb_mini_top_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_s) {
...
__xlx_a__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_a)[i]);
  ...
  // DUT call
  mini_top(__xlx_a__tmp_vec.data(), __xlx_apatb_param_s);
