...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename f1 \
    op interface \
    ports { f1_address0 { O 7 vector } f1_ce0 { O 1 bit } f1_we0 { O 1 bit } f1_d0 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'f1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename l3 \
    op interface \
    ports { l3_address0 { O 10 vector } l3_ce0 { O 1 bit } l3_q0 { I 1 vector } } \
} "
} else {
